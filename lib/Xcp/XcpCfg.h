...
#define vuint8 uint8_t /* Unsigned 8-bit identifier */
#define vuint16 uint16_t /* Unsigned 16-bit identifier */
#define vuint32 uint32_t /* Unsigned 32-bit identifier */
...
#define kXcpStationIdLength   127 

//extern vuint8 const kXcpStationId[kXcpStationIdLength];
extern const char kXcpStationId[kXcpStationIdLength];
