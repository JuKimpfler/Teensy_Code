...
class IRC {
    ...
    public:
        ...
        const int16_t miniw[16] = {29,34,29,31,28,30,30,27,26,25,12,19,145,28,29,0};
        const uint16_t maxiw[16] = {2127,2056,2021,1849,2157,2187,2100,2100,1864,1832,379,1643,2222,2071,2065,40};
        void read();
