...
void RobotC::Drive_Sond(float Dir){
    ...
    */
    ...
    Vel[VR_Motor] = sinf((Dir_A+45)*DEG_TO_RAD)*15 ;
    Vel[VL_Motor] = sinf((Dir_A+315)*DEG_TO_RAD)*15 ;
    Vel[HR_Motor] = sinf((Dir_A+135)*DEG_TO_RAD)*15 ;
    Vel[HL_Motor] = sinf((Dir_A+225)*DEG_TO_RAD)*15 ;
