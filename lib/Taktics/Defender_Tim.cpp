...
bool Defender_Tim::is_Ball_Still(KickState& state, float ball_angle, double ball_distance) {
...
bool Defender_Tim::check_Kick_Trigger(KickState& state, float ball_angle, double ball_distance) {
...
bool Defender_Tim::handle_Ball_In_Front(float ball_angle, float Goal_angle, float LinieWinkel, float Line_distance) {
...
void Defender_Tim::find_Closest_Sensor(bool Line_sensors_active[], float ball_angle, float ball_x_distance, float speed) {
...
double Defender_Tim::normalizeAngle(double angle) {
